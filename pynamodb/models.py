...
from pynamodb.constants import (
    ...
    COUNT, ITEM_COUNT, KEY, UNPROCESSED_ITEMS, MAX_BACKOFF, BACKOFF, STREAM_VIEW_TYPE,
    STREAM_SPECIFICATION, STREAM_ENABLED)
...
class Model(with_metaclass(MetaModel)):
    ...
    def query(cls,
        ...
        query_kwargs = {'index_name': index_name, 'exclusive_start_key': last_evaluated_key,
                        'consistent_read': consistent_read, 'scan_index_forward': scan_index_forward, 'limit': limit,
                        'key_conditions': key_conditions, 'attributes_to_get': attributes_to_get,
    ...
    def _get_connection(cls):
        ...
        if cls._connection is None:
            cls._connection = TableConnection(cls.Meta.table_name, region=cls.Meta.region, host=cls.Meta.host,
                                              session_cls=cls.Meta.session_cls, backoff=cls.Meta.backoff,
                                              max_backoff=cls.Meta.max_backoff)
